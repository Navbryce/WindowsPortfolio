...
export class TaskbarComponent implements OnInit {
    ...
    public clickListener(programStatus: any, action: number) { // called when a program icon has been clicked; action - indicates what was clicked: main button - 0; little close button - ()-1)
        if (action === 0) {
